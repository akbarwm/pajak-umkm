                    ...
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow" href="javascript:void(0)"
                            ...
                            <ul aria-expanded="false" class="collapse  first-level base-level-line">
                                ...
                                <li class="sidebar-item"><a href="user-form-input-grid.php" class="sidebar-link"><span
                                            class="hide-menu"> Form Grids
                                        </span></a>
                                </li>
                                <li class="sidebar-item"><a href="user-orm-checkbox-radio.php"
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="text-muted">
                                    ...
                                    right of page by specifying classes <code>modal-top</code>,
