                ...
                <div class="questions">
                    <table>
                        ...
                        <?php while ($row = mysqli_fetch_assoc($result)) : ?>
                            <tr class="odd">
                                <td>Selesai</td>
                                <td><br>Dikirim <?php echo hari_indonesia(date('l', strtotime($row['tanggal']))); ?>, <?php echo date('j', strtotime($row['tanggal'])); ?> <?php echo bulan_indonesia(date('F', strtotime($row['tanggal']))); ?> <?php echo date('Y', strtotime($row['tanggal'])); ?></td>
