...
?>
        ...
        <div class="spesialis-chooser col-12 col-sm-7 mt-5 mb-5">
            ...
            <div class="row mb-3 border-bottom">
                <div class="col p-0">
                    <div class="">
                        <a class="btn btn-light" href="index.php" role="button"><span><i class="bi bi-chevron-left"></i></span>kembali</a>
                    ...
                    <div class="col-12 col-sm-6 mb-3">
                        <div class="row">
                            ...
                            <div class="col-8 px-2 px-sm-3">
                                ...
                                <br>
                                <a class="btn btn-primary chatNow" style="background-color: #01a0f9; width: 100px;" href="login.php">Chat</a>
                            </div>
                        </div>
                    </div>
                </div>
