    ...
    <div class="container mt-5 mb-5">
        <div class="box ">
            <div class="text-left mt-4 ml-4 ">
                <h4 class="no-margin">Pertanyaan 3</h4>
            ...
            <div class="container mt-5 mb-5">
                <div class="box1 ">
                    ...
                    <div class="text-container mt-4 ml-4">
                        <p><span class="text-left lowered-text">Mas Danar bekerja di PT.EDG sebagai karyawan tetap dengan gaji pokok Rp4.700.000 per bulan, tunjangan makan dan transportasi Rp1.000.000. Ia belum berkeluarga dan tidak memiliki tanggungan. Lantas berapa PPh 21 Mas Danar?</span></p>
                         <div class="radio-container">     
                        <form>
                            <input type="radio" id="option1" name="pph" value="55750">
                            <label for="option1">Rp 55.750,00</label><br>
                            <input type="radio" id="option2" name="pph" value="45720">
                            <label for="option2">Rp 45.720,00</label><br>
                            <input type="radio" id="option3" name="pph" value="77750">
                            <label for="option3">Rp 77.750,00</label><br>
                            <input type="radio" id="option4" name="pph" value="45750">
                            <label for="option4">Rp 45.750,00</label><br>
                            <input type="radio" id="option5" name="pph" value="24.570,00">
                            <label for="option5">Rp 24.750,00</label><br>
                        </form>
                        </div>  
                    </div>
                    <div class="box3">
                        ...
                        <a href="quiz4_pajak.php"> <button class="next-button">Selanjutnya</button></a> <!-- Tombol "Selanjutnya" -->
                       <a href="quiz2_pajak.php"> <button class="awal-button">Kembali</button></a>
                    </div>
