    ...
    <div class="container mt-5 mb-5">
        <div class="box ">
            <div class="text-left mt-4 ml-4 ">
                <h4 class="no-margin">Pertanyaan 1</h4>
            ...
            <div class="container mt-5 mb-5">
                <div class="box1 ">
                    ...
                    <div class="text-container mt-4 ml-4">
                        <p><span class="text-left lowered-text">Ahmad Zakaria pada tahun 2015 bekerja pada perusahaan PT
                                Zamrud Abadi dengan memperoleh gaji sebulan Rp 6.000.000,00 dan membayar iuran pensiun
                                sebesar Rp 100.000,00. Ahmad menikah tetapi belum mempunyai anak. Bagaimana Penghitungan
                                PPh Pasal 21 ?</span></p>
                        <div class="radio-container">
                        <form>
                            <input type="radio" id="option1" name="pph" value="200000">
                            <label for="option1">Rp 200.000,00</label><br>
                            <input type="radio" id="option2" name="pph" value="177000">
                            <label for="option2">Rp 177.000,00</label><br>
                            <input type="radio" id="option3" name="pph" value="217000">
                            <label for="option3">Rp 217.000,00</label><br>
                            <input type="radio" id="option4" name="pph" value="117100">
                            <label for="option4">Rp 117.100,00</label><br>
                            <input type="radio" id="option5" name="pph" value="117500">
                            <label for="option5">Rp 117.500,00</label><br>
                        </form>
                        </div>
                    </div>
                    <div class="box3">
                        ...
                        <a href="quiz2_pajak.php"><button class="next-button">Selanjutnya</button> </a><!-- Tombol "Selanjutnya" -->
                    </div>
