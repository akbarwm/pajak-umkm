...
if (isset($_POST['type'])) {
    if ($_POST['type'] == 'hapus') {
        $id = $_POST['id'];
        $result = mysqli_query($db, "DELETE FROM kategori_usaha where id ='$id'");
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="add-row" class="display table table-striped table-hover">
                                        ...
                                        <tbody>
                                            <?php
                                            $sql = "SELECT * FROM kategori_usaha";
                                            $result = mysqli_query($db, $sql);
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width: 20%">
                                                        <div class="form-button-action">
                                                            <a href="edit_usaha.php?id=<?= $r['id']; ?>" type="button" data-toggle="tooltip" title="" class="btn btn-link btn-primary btn-lg" data-original-title="Edit">
