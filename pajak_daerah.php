        ...
        <div class="container">
            <div class="privacy-part">
                <div class="single-privacy mb-50">
                    ...
                    $data = mysqli_query($db, "select * from peraturan_pajak where kategori='pajak daerah'");
                    $jumlah_data = mysqli_num_rows($data);
                    $total_halaman = ceil($jumlah_data / $batas);
                    //  var_dump("select * peraturan_pajak  LIMIT $batas OFFSET $halaman_awal");die;
                    $data_pegawai = mysqli_query($db, "select * FROM peraturan_pajak where kategori='pajak daerah'  LIMIT $batas OFFSET $halaman_awal");
