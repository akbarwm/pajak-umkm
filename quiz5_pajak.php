    ...
    <div class="container mt-5 mb-5">
        <div class="box ">
            <div class="text-left mt-4 ml-4 ">
                <h4 class="no-margin">Pertanyaan 5  </h4>
            ...
            <div class="container mt-5 mb-5">
                <div class="box1 ">
                    ...
                    <div class="text-container mt-4 ml-4">
                        <p><span class="text-left lowered-text">Bagi penerima penghasilan yang tidak memiliki NPWP, dikenakan pemotongan  PPh Pasal 21 dengan tarif lebih tinggi 20% daripada tarif yang  diterapkan terhadap wajib pajak yang memiliki NPWP.</span></p>
                         <div class="radio-container">     
                        <form>
                            <input type="radio" id="option1" name="pph" value="benar">
                            <label for="option1">Benar</label><br>
                            <input type="radio" id="option2" name="pph" value="salah">
                            <label for="option2">Salah</label><br>
                    ...
                    <div class="box3">
                        ...
                        <a href="#"> <button class="next-button">Selesai</button></a> <!-- Tombol "Selanjutnya" -->
                       <a href="quiz4_pajak.php"> <button class="awal-button">Kembali</button></a>
                    </div>
